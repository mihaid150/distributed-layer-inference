...
using dli_stage::DliFrame;
using dli_stage::ProtocolError;
using dli_stage::decode_frame;
using dli_stage::encode_frame;

void test_roundtrip_with_tensor() {
    DliFrame frame;
    frame.metadata_json = R"({"request_id":"abc","token_index":1,"tensor":{"dtype":"float16","shape":[1,1,2048]}})";
