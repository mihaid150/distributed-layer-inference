...
from dli.stage_runtimes.python_legacy.activation_codec import ActivationCodec
from dli.stage_runtimes.python_legacy.model_partition_loader import ModelPartitionLoader
from dli.stage_runtimes.python_legacy.stage_config import StageConfig, load_stage_config
from dli.stage_runtimes.python_legacy.stage_executor import StageExecutor
...
def config() -> Dict[str, Any]:
    return {
        "service_name": stage_config.service_name,
        "stage_id": stage_config.stage_id,
        "backend": "python-pytorch-legacy",
        "model_format": "pytorch-pt",
        "partition_file": stage_config.partition_file,
        "partition_profiles": stage_config.partition_profiles,
        "components": {
            "embedding": stage_config.components.embedding,
            "layers": stage_config.components.layers,
            "norm": stage_config.components.norm,
            "lm_head": stage_config.components.lm_head,
        },
        "next_stage_url": stage_config.next_stage_url,
        "supports_binary_v2": True,
        "supports_kv_cache": True,
        "hidden_dtype": "torch.float16 transport / source dtype compute",
    }
